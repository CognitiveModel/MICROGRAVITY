...
from nanobot.agent.ui.ui_controller.mouse import MouseController # type: ignore
from nanobot.agent.ui.ui_controller.keyboard import KeyboardController # type: ignore
from nanobot.agent.ui.ui_controller.window_manager import WindowManager # type: ignore
from nanobot.agent.ui.perception.screen import ScreenObserver, WindowObserver # type: ignore
from nanobot.agent.ui.perception.vision_analyzer import VisionAnalyzer # type: ignore
from nanobot.agent.ui.planning.goal_manager import GoalManager # type: ignore
from nanobot.agent.ui.planning.action_predictor import ActionPredictor # type: ignore
from nanobot.agent.ui.planning.learning_loop import LearningLoop # type: ignore
from nanobot.agent.ui.planning.agentic_planner import AgenticPlanner # type: ignore
from nanobot.agent.ui.core.ui_memory_agent import UIMemoryAgent # type: ignore
from nanobot.agent.ui.ui_controller.live_streamer import GeminiLiveStreamer # type: ignore
from nanobot.agent.ui.ui_controller.hud_overlay import HUDOverlay # type: ignore
from nanobot.agent.ui.core.tools.browser_tool import BrowserTool # type: ignore
from nanobot.agent.ui.core.tools.automation_artifacts import AutomationArtifactRegistry # type: ignore
from nanobot.agent.ui.core.tools.swarm_script_manager import SwarmScriptManager # type: ignore
from nanobot.agent.ui.perception.cv_logger import CVLogger # type: ignore
from nanobot.agent.ui.perception.anticipatory_observer import AnticipatoryObserver, ProcessContext # type: ignore
from nanobot.agent.ui.perception.window_state_validator import WindowStateValidator # type: ignore
from nanobot.agent.ui.planning.loop_sentinel import LoopRecoveryEngine, LoopSeverity # type: ignore
import win32gui # type: ignore
import win32con # type: ignore
import asyncio
import threading
import cv2 # type: ignore
from nanobot.agent.ui.utils.vision_utils import adapt_rect_to_edges # type: ignore
from nanobot.agent.ui.perception.edge_engine import EdgePerceptionEngine # type: ignore
...
class UIAgent:
    ...
    def __init__(self):
        ...
        from nanobot.agent.ui.utils.screen_geometry import ScreenGeometry # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.cursor_monitor import CursorMonitor # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.cursor_snip_verifier import CursorSnipVerifier # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.cv_pipeline import CVPipeline # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.static_dynamic_classifier import StaticDynamicClassifier # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.element_boundary_learner import ElementBoundaryLearner # type: ignore
        ...
        # ═══ Layer 1: OSAwareness ═══
        try:
            from nanobot.agent.ui.perception.os_awareness import OSAwareness # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.app_characterizer import AppCharacterizer # type: ignore
        ...
        try:
            from nanobot.agent.ui.planning.situational_awareness import SituationalAwareness # type: ignore
        ...
        try:
            from nanobot.agent.ui.perception.edge_correlator import EdgeCorrelator # type: ignore
            from nanobot.agent.ui.planning.action_outcome_tracker import ActionOutcomeTracker # type: ignore
            from nanobot.agent.ui.planning.presumption_engine import PresumptionEngine # type: ignore
            from nanobot.agent.ui.planning.postponed_judgement import PostponedJudgement # type: ignore
        ...
        try:
            from nanobot.agent.ui.planning.decision_manager import DecisionManager # type: ignore
        ...
        try:
            from nanobot.agent.ui.core.hitl_contextualizer import HITLContextualizer # type: ignore
            from nanobot.agent.ui.core.swarm_interface import SwarmInterface # type: ignore
    ...
    def run_agentic(self, task: str):
        ...
        """
    def run_agentic(self, task: str, send_callback=None):
        self.is_running = True
        print("[UIAgent] ===========================================")
        ...
        # Wire swarm interface interrupts to this specific planner session
        if hasattr(self, 'swarm_interface') and self.swarm_interface:
            self.swarm_interface.register_interrupt_callback(planner.inject_hitl_interrupt)
    ...
    def _execute_action(self, action: Dict[str, Any]):
        ...
        # ── Edge Correlation Tool Dispatchers ──
             ...
             if current_screen is not None and hasattr(self, 'edge_correlator'):
                 from nanobot.agent.ui.perception.cv_pipeline import UIElement # type: ignore
...
if __name__ == "__main__":
    agent = UIAgent()
    agent.run_agentic("Close the Notepad application.")
