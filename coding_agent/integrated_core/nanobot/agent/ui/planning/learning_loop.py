...
try:
    from nanobot.agent.ui.planning.action_outcome_tracker import ActionOutcomeTracker, OutcomeLevel, FailureCategory, SemiSuccessCategory  # type: ignore
    ...
    from nanobot.agent.ui.perception.anticipatory_observer import AnticipatoryObserver  # type: ignore
except ImportError:
